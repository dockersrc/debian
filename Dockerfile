...
ARG IMAGE_REPO="casjaysdev/debian"
...
ARG PACK_LIST="bash-completion git curl wget sudo unzip tini xz-utils iproute2 pinentry-curses bsd-mailx procps net-tools bsd-mailx postfix python3-icu python3-pip ca-certificates jq "
